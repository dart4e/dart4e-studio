...
user in an INI file next to Dart4EStudioPortable.exe called Dart4EStudioPortable.ini.
...
copy AppNamePortable.ini from this directory to Dart4EStudioPortable.ini next to
Dart4EStudioPortable.exe. The options in the INI file are as follows:
