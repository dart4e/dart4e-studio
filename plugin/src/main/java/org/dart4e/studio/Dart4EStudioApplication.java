...
public class Dart4EStudioApplication extends IDEApplication {
   ...
   public Object start(final @Nullable IApplicationContext ctx) throws Exception {
      ...
      try {
         ...
         final var rc = PlatformUI.createAndRunWorkbench(display, new Dart4EStudioWorkbenchAdvisor(processor));
